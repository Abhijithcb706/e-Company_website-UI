...
useEffect(() => {
    // Set the nav state to false when the component mounts
    setNav(true);
  }, []);
return (
<div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white '>
    {/* <img
        src='https://st2.depositphotos.com/1024516/7326/v/450/depositphotos_73261477-stock-illustration-vector-logo-for-letter-e.jpg'
    ...
    <div className={!nav
        ? 'md:hidden fixed left-0 top-0 w-[50%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-700'
